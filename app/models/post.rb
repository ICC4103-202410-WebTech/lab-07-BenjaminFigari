class Post < ApplicationRecord
    ...
    validates :user_id, presence: { message: "The post must have a user_id" }
    ...
    validates :likes_count, numericality: { greater_than_or_equal_to: 0, message: "The likes_count should be a positive number. How many likes does the post have?" }
